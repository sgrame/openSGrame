 ...
 * @group SG_Rule
 */
class SG_Rule_Parser_Comparison_GreatherThanOrEqualTest extends PHPUnit_Framework_TestCase
{
    /**
     * Test the parser 
     */
    public function testParse()
    {
        ...
        $parser = new SG_Rule_Parser_Comparison_GreatherThanOrEqual();
        
        $result = $parser->parse('50>=20', $patterns);
        $this->assertInstanceOf('SG_Rule_Comparison_GreatherThanOrEqual', $result);
    }
