 ...
 * @group SG_Rule
 */
class SG_Rule_Comparison_NotEqualTest extends PHPUnit_Framework_TestCase
{
    /**
     * Test the operators
     */
    public function testNotEqual()
    {
        ...
        $comparison = new SG_Rule_Comparison_NotEqual(
            $param30, 
            $param70
        );
    ...
    public function testToString()
    {
        ...
        $comparison = new SG_Rule_Comparison_NotEqual($left, $right);
