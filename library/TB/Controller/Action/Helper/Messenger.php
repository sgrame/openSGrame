...
/**
 * TB_Controller_Action_Helper_Messenger
 *
 ...
 * 
 * Or direct with indication of the message type.
 *
 * @category TB
 * @package  Form
 * @author   Peter Decuyper <sgrame@gmail.com>
 ...
 * @link     https://github.com/sgrame/openSGrame
 */
class TB_Controller_Action_Helper_Messenger
    extends Zend_Controller_Action_Helper_Abstract
{
    ...
    {
        return $this->addMessage($type, $message, $actions);
    }
}
